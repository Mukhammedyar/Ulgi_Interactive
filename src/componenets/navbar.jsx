...
export default function Navbar() {
  ...
  return (
    <div className='navbar-box px-10 md:px-16 sticky top-0 z-10 bg-[rgba(255,255,255,.5)] backdrop-blur-sm text-zinc-900 -translate-y-[100%] opacity-0' >
        ...
        <div className={`mobile-sidebar`}>
            ...
            <div className="gap-7 text-sm md:text-md text-center md:hidden flex-between text-zinc-900 flex-col mt-12 relative">
                ...
                <span className='text-hover item flex md:hidden gap-2' onClick={handleToggle}>
                    Baylanıs
                    <PhoneIcon width={20} height={20}/>
                </span>
                <ContactsModal open={open} />
