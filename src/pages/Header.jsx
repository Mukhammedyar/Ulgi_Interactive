...
export default function Header() {
  ...
  return (
    <div>
        <section id='Header' className='header -mt-20 text-zinc-800 flex-center flex-col container-box w-full h-[95vh]'>
            <h1 className="text-3xl md:text-5xl lg:text-5xl text-center px-10 header-text poppins-bold">
                    <span className='text'>«Úlgi» </span>
                    <span className='text'>joybarı </span>
                    <span className='text'>menen </span>
                    <span className='text'>qaraqalpaqsha </span>
            ...
            <form action="Post" className='w-full flex-center gap-2 mt-24'>
                <input
                    ...
                    <button className="icon search-button opacity-0 -translate-x-10" onClick={(e) => {
                        e.preventDefault() 
                    }}>
